...
document.querySelector<HTMLDivElement>(".header-container")?.appendChild(header.get());

const menu = new Menu("discover");
document.querySelector<HTMLDivElement>(".menu-container")?.appendChild(menu.get());
...
for (let c of categories) {
    categoriesContainer?.appendChild(c.get());
}
