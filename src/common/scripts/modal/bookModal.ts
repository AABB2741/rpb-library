class BookModal {
    ...
    private build(): HTMLElement {
        ...
        bookModalSummary.innerHTML = this.details?.summary ?? "Este livro não possui um resumo.";
        ...
        if (this.details) {
            ...
            for (let k of Object.keys(this.details)) {
                ...
                tdk.innerText = bookModalDetailsLang[k as keyof BookDetails] ?? k;
                tdv.innerText = String(this.details[k as keyof BookDetails]);
                tr.appendChild(tdk);
                tr.appendChild(tdv);
